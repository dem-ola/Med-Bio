...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(8), __webpack_require__(13)(module)))
...
// CONCATENATED MODULE: ./js/reducers.js
...
var store_store = createStore(userStatus);
...
var params = {
  ...
  backendport: 3000,
  frontendport: 8080,
  // clearly not relevant in production
...
ReactDOM.render(React.createElement("div", null), // empty so DidMount will work
document.getElementById('root'));
// CONCATENATED MODULE: ./js/actions.js
      ...
      fetch(url, {
        ...
        if (respJson.msg) {
          ...
          store_store.subscribe(function () {
            return store_store.getState();
          });
          store_store.dispatch(setLoggedIn('LOGGED-IN'));

          _this2.props.onLogAction();
...
function (_React$Component) {
  ...
  navigation_createClass(Navigation, [{
    ...
    value: function render() {
      ...
      var links = Object.assign({}, this.props.links);
...
function (_React$Component) {
  ...
  logout_createClass(Logout, [{
    ...
    value: function submit() {
      var newPage = window.open('', '_self');
      var newUrl = "".concat(logout_baseHttpUrl, "/").concat(routes['home']);
      store_store.subscribe(function () {
        return store_store.getState();
      });
      store_store.dispatch(setLoggedOut('LOGGED-OUT'));
...
function js_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var js_routes = {
  ...
  "/html/login.html": [React.createElement(login, null), 'Login'],
  ...
  "/html/logout.html": [React.createElement(logout_Logout, null), 'Logout']
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.onLogAction = _this.onLogAction.bind(js_assertThisInitialized(_this));
    _this.state = {
      loggedIn: 'null'
    };
    return _this;
  ...
  js_createClass(App, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var localStore = getStore(params.localStorageKey);

      if (localStore) {
        // not null
        for (var _i = 0, _Object$keys = Object.keys(this.state); _i < _Object$keys.length; _i++) {
          var k = _Object$keys[_i];
          this.setState(js_defineProperty({}, k, localStore[k]));
        }
      }
    }
  }, {
    key: "onLogAction",
    value: function onLogAction() {
      ...
      var reduxed = store_store.getState();
      var localStore = getStore(params.localStorageKey);

      for (var _i2 = 0, _Object$keys2 = Object.keys(localStore); _i2 < _Object$keys2.length; _i2++) {
      ...
      setStore(params.localStorageKey, localStore);
    }
  }, {
    key: "render",
    value: function render() {
      return React.createElement(js_Page, {
        ...
        content: React.createElement(js_Content, {
          content: React.createElement(react_router_dom_BrowserRouter, null, React.createElement(react_router_Switch, null, React.createElement(react_router_Route, {
            exact: true,
            path: "/html/login.html"
          }, React.createElement(login, {
            onLogAction: this.onLogAction
          })), React.createElement(react_router_Route, {
            exact: true,
            path: "/html/logout.html"
          }, React.createElement(logout_Logout, {
            onLogAction: this.onLogAction
          })), React.createElement(react_router_Route, {
            path: theRoute
          }, js_component)))
